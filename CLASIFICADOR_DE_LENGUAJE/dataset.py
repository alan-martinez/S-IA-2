...
class LanguageClassificationDataset():
    def __init__(self, model):
        ...
        # Seleccione algunos ejemplos para destacar en la fase de seguimiento (3 por idioma)
        spotlight_idxs = []
        ...
        # Plantillas para imprimir actualizaciones a medida que avanza el entrenamiento
    ...
    def iterate_once(self, batch_size):
        assert isinstance(batch_size, int) and batch_size > 0, (
            "El tamaño del lote debe ser un número entero positivo, obtenido {!r}".format(
                batch_size))
        assert self.train_x.shape[0] >= batch_size, (
            "El tamaño del conjunto de datos {:d} es más pequeño que el tamaño del lote {:d}".format(
        ...
        for iteration in range(self.train_x.shape[0] // batch_size):
            ...
            if time.time() - self.last_update > 0.5:
                ...
                print("epoca {:,} iteracion {:,} porcentaje-validacion {:.1%}".format(
