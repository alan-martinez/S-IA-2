...
def get_predicted_language(probs):
    languages = ["English", "Spanish", "Finlandés", "Holandés", "Polaco"]
    max_index = 0
    max_val = -float("inf")
...
def main():
    ...
    print("precisión del test es de: {:%}\n".format(test_accuracy))

    while True:
        word = input("Palabra a clasificar: (q para salir): ")
        ...
        print("el lenguaje predicho es: {}, con una precisión de {:%}\n".format(pred_lang, max_prob))
